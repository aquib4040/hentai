...
PICS = (environ.get('PICS', 'https://i.ibb.co/SwtF3jnt/6183581183783323158.jpg')).split() # Bot Start Picture
...
SHORTLINK_API = environ.get("SHORTLINK_API", "7e92a99228ab9aa73ac42f953328f33456dd922d") # shortlink api
